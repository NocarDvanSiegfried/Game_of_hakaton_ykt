...
```text
scene1_timeline -> scene2_timeline -> scene3_timeline -> scene4_timeline -> scene5_timeline
```

Play through Scenes 1, 2, and 3. After Scene 3 ends, Scene 4 should start automatically. After Scene 4 ends, Scene 5 should start automatically. After Scene 5 ends, the Output panel should print:

```text
Сцена 5 завершена. Здесь будет переход к Сцене 6.
```
